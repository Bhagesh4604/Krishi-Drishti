      ...
      <div className={`flex border-b ${viewMode === 'shorts' ? 'bg-black border-white/10' : 'bg-white border-gray-100'}`}>
        <button 
          ...
          className={`flex-1 py-3 text-xs font-black uppercase tracking-widest transition-all ${
            viewMode === 'feed' ? 'text-green-700 border-b-2 border-green-700' : 'text-gray-400'
          }`}
        >
          Community Feed
        </button>
        <button 
          ...
          className={`flex-1 py-3 text-xs font-black uppercase tracking-widest transition-all ${
            viewMode === 'shorts' ? 'text-white border-b-2 border-white' : 'text-gray-400'
          }`}
        >
          Krishi Shorts
        </button>
       ...
       <div className="p-6 flex justify-between items-center border-b border-white/10">
          ...
          <button 
            ...
            className={`px-6 py-2 rounded-xl text-xs font-black uppercase tracking-widest ${
              step === 2 && !caption ? 'bg-white/10 text-white/30' : 'bg-green-600 text-white'
            }`}
          >
            {step === 1 ? 'Next' : 'Share'}
          </button>
