    ...
    <div className="h-full bg-white flex flex-col relative">
      ...
      <div className="bg-white p-6 pb-8 shadow-sm border-b border-gray-100 sticky top-0 z-20">
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            <h2 className="text-2xl font-black text-gray-900 leading-none">{t.create_profile}</h2>
          </div>
        </div>
        <p className="text-gray-500 text-sm">{t.farm_details}</p>
      </div>
      ...
      <div className="flex-1 px-6 pt-6 pb-10 overflow-y-auto">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-2 focus:ring-green-500 outline-none text-gray-900 font-bold appearance-none pr-10"
                >
        ...
        <div className="mt-8 pb-10">
          <button
            ...
            className="w-full py-4 rounded-2xl font-bold text-sm text-white shadow-lg transition-all flex items-center justify-center gap-2 disabled:opacity-50 active:scale-95 bg-green-700"
          >
            {loading ? (
              <>
